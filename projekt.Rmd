...
Pošto uzmimamo moždani kao binarnu varijablu (0 = nema moždanog udara, 1 = imao moždani udar), koristimo logističku regresiju kao provjeru i test za ovo pitanje. Logistički model nam daje procjenu:
...
Iz ovih grafova se već može naslutiti da su **osobe sa moždanim udarom u prosjeku starije** i imaju **višu razinu glukoze**, dok se BMI čini manje izrazito različitim.
...
-   **ROC krivulja** prikazuje omjer **osjetljivosti (sensitivnost)** i **1 - specifičnost** za sve moguće pragove vjerojatnosti.
